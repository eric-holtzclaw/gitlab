...
**GitLab:** http://10.0.0.16:8080/infrastructure/gitlab (Static IP - No port-forward needed)  
...
**Static IP:** 10.0.0.16 (LoadBalancer service)
...
- **Web UI:** http://10.0.0.16:8080 (Static IP - No port-forward needed)
...
- **SSH:** `ssh://git@10.0.0.16:2222/group/repo.git` (Static IP)
...
```bash
git remote add origin ssh://git@10.0.0.16:2222/open-source-development/google-workspace-forensics-investigator.git
git branch -M main
...
git remote add origin http://oauth2:${GITLAB_TOKEN}@10.0.0.16:8080/open-source-development/google-workspace-forensics-investigator.git
...
- **Core K8s DevOps:** `/Users/eric/Documents/Scripts/core/k8s-devops/`
